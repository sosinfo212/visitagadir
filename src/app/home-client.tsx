      ...
      <footer className="bg-gray-900 text-white mt-auto">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2.5 mb-4">
                <img
                  src={siteBranding.footerLogoUrl}
                  alt={siteBranding.siteName}
                  className="rounded-lg object-contain"
                  style={{
                    width: siteBranding.footerLogoWidth,
                    height: siteBranding.footerLogoHeight,
                  }}
                />
                <span className="font-bold text-lg">{siteBranding.siteName}</span>
              </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-gray-500">
            <p>&copy; {new Date().getFullYear()} {siteBranding.siteName}. All rights reserved.</p>
            <div className="flex items-center gap-4">
